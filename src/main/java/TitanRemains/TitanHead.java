...
public class TitanHead extends GameStaticObject {
    ...
    public TitanHead(Point possition, GraphicsContext graphicsContext, MonitorWindow monitorWindow) {
        super(getPoints(possition), getPoints(possition), getPoints(possition), possition, 512, 512, 0, graphicsContext, monitorWindow, LoadAllResources.getMapOfAllImages().get("TitanFace"));
    }
