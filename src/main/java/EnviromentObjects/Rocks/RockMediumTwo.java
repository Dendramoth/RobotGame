...
public class RockMediumTwo extends GameStaticObject {
    ...
    public RockMediumTwo(Point possition, GraphicsContext graphicsContext, MonitorWindow monitorWindow) {
        super(getPoints(possition), getPoints(possition), getPoints(possition), possition, 128, 128, 0, graphicsContext, monitorWindow, LoadAllResources.getMapOfAllImages().get("rockMediumTwo"));
    }
