 ...
 * @author Dendra
 */
public class RockMediumThree extends GameStaticObject {
    ...
    public RockMediumThree(Point possition, GraphicsContext graphicsContext, MonitorWindow monitorWindow) {
        super(getPoints(possition), possition, 128, 128, 0, graphicsContext, monitorWindow, LoadAllResources.getMapOfAllImages().get("rockMediumThree"));
    }
