 ...
 * @author Dendra
 */
public class DryLandSmallOne extends GamePrimitiveObject {
    private final Image craterImage = LoadAllResources.getMapOfAllImages().get("Dry_land_small_one");

    public DryLandSmallOne(Point possition, GraphicsContext graphicsContext, MonitorWindow monitorWindow) {
