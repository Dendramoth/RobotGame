...
public class CliffTopLeft extends GameStaticObject{
    private final Image cliffTopLeftImage = LoadAllResources.getMapOfAllImages().get("cliffTopLeftCorner");
    ...
    public void paintGameObject() {
        ...
        graphicsContext.drawImage(cliffTopLeftImage, worldPossition.getCoordX() - monitorPossition.getCoordX(), worldPossition.getCoordY() - monitorPossition.getCoordY());
    }
